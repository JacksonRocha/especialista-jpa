insert into produto (id, nome, preco, descricao) values (1, 'Kindle', 499.0, 'Conheça o novo Kindle, agora com que permite que você leia em ambientes abertos ou fechados, a qualquer hora do dia');
