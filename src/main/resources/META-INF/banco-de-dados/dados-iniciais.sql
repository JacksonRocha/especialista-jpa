insert into produto (id, nome, preco, data_criacao, descricao) values (1, 'Kindle', 499.0, date_sub(sysdate(), interval 1 day ),'Conheça o novo Kindle, agora com que permite que você leia em ambientes abertos ou fechados, a qualquer hora do dia');
...
insert into pagamento (pedido_id, status, tipo_pagamento, numero_cartao, codigo_barras) values (1, 'PROCESSANDO', 'cartao', '123', null);
